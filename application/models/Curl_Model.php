...
Class Curl_Model extends CI_Model{
	...
	public function data(){
			   ...
			   $url = "http://api.dvlp.sisrute.kemkes.go.id/rsonline/referensi/sdm";
			   ...
			   return $this->list = json_decode($result,true);
	}
	
	function searchById($input){
		echo json_encode($this->list[0]);
		return array_search($input,$this->list);
